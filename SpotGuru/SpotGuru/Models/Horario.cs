...
namespace SpotGuru.Models
{
    public class Horario
    {
        ...
        public List<SlotDispoivel> SlotsDisponiveis { get; set; }

        public Horario()
        {

        }
        public Horario(int id, int horaAbertura, int horaEncerrament, float custoSlot, List<Slots> slots, List<SlotDispoivel> slotsDisponiveis)
        {
            Id = id;
